...
public class Parameters {
	...
	public static final String file_location = "..\\OSER\\DataSet"; 
	
	/**The workflow template's txt file*/
	public static final String workflowTemplateFile = "..\\OSER\\workflowTemplate.txt"; 

	/**The VM template's txt file*/
	public static final String vmTemplateFile = "..\\OSER\\vmTemplate.txt"; 
	...
	public static double dvCpuUtilize = 2; //Used in the NormalDistribution method to get actual CPU utilization of each execute time
	...
	public static Scheduler[] SCHEDULES = {new EcoCloud(),new SAVE(),new OSER()};//Algorithms: new EcoCloud(),new SAVE(),new OSER_old(),
	...
	public static int[] vmNumGroup = {500,1000,2000,5000,10000}; 

	/**The number of the VMs, equals to the number of tasks*/	
	public static int vmNum = 1000;

	/**The arrival rate list of VM*/
	public static double[] arrivalLamdaGroup = {0.2,0.4,0.8,1.2,1.6};//0.2,0.4,0.8,1.2,1.6
	
	/**The arrival rate of VM*/
	public static double arrivalLamda = 0.8;//0.8
	...
	public static int[] timeSlotGroup = {9,5,2,1,1};//1,1,2,3,5  5,3,2,1,1 1,1,2,4,6
	...
	public static String Result_file_location = "..\\OSER\\Result\\"; 
	
	/**The result file name*/
	public static String resultFile = "VM Number.txt";
	
	/**The each time result file name*/
	public static String eachTimeResult = "..\\OSER\\Result\\eachTime\\";
	
	/**The current algorithm number*/
	public static int currentAlgorithm = 0; //0 EcoCloud, 1 SAVE, 2 OSER
